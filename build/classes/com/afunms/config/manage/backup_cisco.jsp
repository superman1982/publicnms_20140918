...
setTimeout(function(){
 ...
 Ext.get("process_run").on("click",function(){
  
    //var chk = checkinput("alias","string","机器名",30,false);
     //if(chk)
     {
     	Ext.MessageBox.wait('数据加载中，请稍后.. ');
        mainForm.action = "<%=rootPath%>/vpntelnetconf.do?action=bkpCfg&bkptype=run";
        mainForm.submit();
        //window.close();
     }
       // mainForm.submit();
 });	
Ext.get("process_startup").on("click",function(){
  
    //var chk = checkinput("alias","string","机器名",30,false);
     //if(chk)
     {
     	Ext.MessageBox.wait('数据加载中，请稍后.. ');
        mainForm.action = "<%=rootPath%>/vpntelnetconf.do?action=bkpCfg&bkptype=startup";
        mainForm.submit();
        //window.close();
     }
       // mainForm.submit();
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">&nbsp;备份配置</td>
				        										...
				        										<td>
				        												...
				        												<table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
																			...
																			<tr>
																				...
																				<br><input type="button" value="备份运行文件" style="width:80" id="process_run" onclick="#">&nbsp;&nbsp;
																				<input type="button" value="备份启动文件" style="width:80" id="process_startup" onclick="#">&nbsp;&nbsp;
