...
public class GgsciConfigDao extends BaseDao implements DaoInterface {

	public GgsciConfigDao() {
		
		super("nms_ggsciconfig");
	...
	public BaseVo loadFromRS(ResultSet rs) {
		...
		try {
			...
			SysLogger.error("GgsciConfigDao.loadFromRS()",e);
		}
		return vo;
	}

	public boolean save(BaseVo vo) {
		GgsciConfig vo1=(GgsciConfig)vo;
		StringBuffer sql=new StringBuffer();
		sql.append("insert into nms_ggsciconfig(id,ipaddress,alias,flag,sendmobiles,sendemail,sendphone,supperid,netid) values('");
	   ...
	   public List getGgsciByBID(Vector bids){
		   ...
		   sql.append("select * from nms_ggsciconfig "+wstr);
	...
	public boolean update(BaseVo vo) {
		GgsciConfig vo1 = (GgsciConfig)vo;
		StringBuffer sql=new StringBuffer();
		sql.append("update nms_ggsciconfig set alias ='");
		sql.append(vo1.getAlias());
		sql.append("',flag='");
		sql.append(vo1.getFlag());
		sql.append("',netid='");
