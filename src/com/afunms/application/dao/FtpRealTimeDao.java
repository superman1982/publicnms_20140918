...
public class FtpRealTimeDao extends BaseDao implements DaoInterface
{
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
   public FtpRealTimeDao()
   {
   ...
   {
	   FtpRealTime vo = (FtpRealTime)baseVo;	  
	...
	public Hashtable getAllReal() throws Exception {
		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				FtpRealTime emailmonitor_realtime = (FtpRealTime) list.get(i);
   ...
   {
	   FtpRealTime vo = new FtpRealTime();
       try
       {
