...
public class Emailmonitor_historyDao extends BaseDao implements DaoInterface
{
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
   public Emailmonitor_historyDao()
   {
   ...
   {
	   Emailmonitor_history vo = (Emailmonitor_history)baseVo;	  
...
//			SysLogger.info(sql);
   ...
   {
	   Emailmonitor_history vo = new Emailmonitor_history();
       try
       {
