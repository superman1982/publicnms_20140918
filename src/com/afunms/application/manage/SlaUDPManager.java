...
public class SlaUDPManager extends BaseManager implements ManagerInterface
{
	private String list()
	{
...
//		}
		...
		try {
		   ...
		   if(rbids != null && rbids.size()>0){
			   ...
			   wstr=wstr+") and slatype='udpecho'";
		   }
		request.setAttribute("telnetHash",telnetHash);
		setTarget("/application/slaudp/listperf.jsp");
		configdao = new SlaNodeConfigDao();
...
//			String totime1 = t_time + " 23:59:59";
	...
	public String showmap() {
         request.setAttribute("slatype", "udp");
