...
public class InformixJdbcUtil {
	
	String strconn;
	String strDriver = "com.informix.jdbc.IfxDriver";
	...
	public InformixJdbcUtil(String url,String name,String pass){
		this.strconn = url;
		this.name = name;
		this.pass = pass;
	}
...
//			SysLogger.info(name+"........"+pass+"----------informix----------------"+strconn);
