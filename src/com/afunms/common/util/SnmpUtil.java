...
//          if (ipArray.length == 1) {
//              if (ipArray[0][0] == null || ipArray[0][1] == null) {
//                  try {
//                      ipArray = SnmpUtils.walkTable(address, community, oidsNew);
//                  } catch (Exception e) {
//                      e.printStackTrace();
//                  }
//              }
...
//	  SysLogger.info("##########################################");
//	  SysLogger.info("MAC bridge========"+bridge);
//	  SysLogger.info("##########################################");
	  return bridge;
  }
...
//    	 System.out.println("--------snmpUtil-----------929----------->"+DiscoverResource.getInstance());
//    	 System.out.println("--------snmpUtil-----------930----------->"+DiscoverResource.getInstance().getDeviceType());
//    	 System.out.println("--------snmpUtil-----------931----------->"+DiscoverResource.getInstance().getDeviceType().get(sysOid));
...
//     	   tableValues.add(ifEntity);
        ...
        //==========端口信息后部分==========
            ...
            try{
            	ipArray4 = snmp.getTableData(address,community,oids4);
            }catch(Exception e){
...
//System.out.println(address+"-------index:"+ipArray3[i][0]+"---ip:"+ipArray3[i][1]);
  ...
  public List getIPRouterTable(String address,String community)
  {
     ...
     {
    	 SysLogger.error("getIPRouterTable(),ip=" + address + ",community=" + community);
         tableValues = null;
     }
     return tableValues;
   }
   ...
   public List getFdbTable(String address,String community)
   {
      ...
      {
    	  e.printStackTrace();
    	  SysLogger.error("getFdbTable(),ip=" + address + ",community=" + community);         
      }
      return tableValues;
   }
