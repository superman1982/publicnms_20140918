...
public class SyslogDefs {
	...
	public static final String LOG_LOGIN_SUCCESS = "528,540";
	public static final String LOG_LOGOUT_SUCCESS = "538";
	public static final String LOG_LOGIN_FAILURE = "529";
	public static final String LOG_LOG_CLEARED = "517";
	public static final String LOG_STRATEGY_MODIFIED = "612";
	public static final String LOG_ACCOUNT_MODIFIED = "626,628,629,642,685";
	public static final String LOG_ACCOUNT_LOCKED = "528,540";
	public static final String LOG_SCECLI_STRATEGY = "528,540";

	public static final String NWLOG_LOGIN_SUCCESS = "/LOGIN(l):";
	public static final String NWLOG_LOGOUT_SUCCESS = "/LOGOUT(l):";
	public static final String NWLOG_LOGIN_FAILURE = "/LOGINFAIL(l):";
//	public static final String NWLOG_LOG_CLEARED = "/LOGIN(l)";
//	public static final String NWLOG_STRATEGY_MODIFIED = "/LOGIN(l)";
//	public static final String NWLOG_ACCOUNT_MODIFIED = "/LOGIN(l)";
//	public static final String NWLOG_ACCOUNT_LOCKED = "/LOGIN(l)";
