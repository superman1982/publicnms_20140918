...
public class M10HostTask extends MonitorTask {
	    	...
	    	if(monitorItemList == null)monitorItemList = new ArrayList<NodeGatherIndicators>();
        		...
        		for (int i=0; i<monitorItemList.size(); i++) {
        			...
        			if(docollcetHash.containsKey(nodeGatherIndicators.getNodeid())){
            			...
            			//SysLogger.info(node.getIpAddress()+"==="+node.getCollecttype()+"==="+nodeGatherIndicators.getName());
...
//            			}
//            			
//        			    ShareData.getSharedata().put("interface"+host.getIpAddress(), interfacedataHash);
//            		}
            		return;
            	}   
