 ...
 *
 */
public class M4Task extends MonitorTask {
...
//			ShareData.setPortConfigHash(portconfigHash);
	    	...
	    	try{
	    		//获取被启用的所有被监视指标
	    		monitorItemList = indicatorsdao.getByIntervalAndType("4", "m",1,"net");
	    	}catch(Exception e){
	    		e.printStackTrace();
	    	}finally{
	    		indicatorsdao.close();
...
//        			threadPool.runTask(createTask(nodeGatherIndicators,alldata));           		
			...
			SysLogger.info("********M4Task Thread Count : "+Thread.activeCount());
		}
	}
