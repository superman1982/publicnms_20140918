...
public class M10MySqlTask extends MonitorTask {
	
	public void run() {
		SysLogger.info("#### 开始执行MYSQL的10分钟采集任务 ####");
		try{
	    	...
	    	try{
	    		//获取被启用的MYSQL所有被监视指标
	    		monitorItemList = indicatorsdao.getByInterval("10", "m",1,"db","mysql");
	    	}catch(Exception e){
	    		e.printStackTrace();
	    	}finally{
	    		indicatorsdao.close();
			...
			SysLogger.info("#### M10MYSQLTask Thread Count : "+Thread.activeCount()+" ####");
		}
	}
