...
public class M1TelnetTask extends MonitorTask 
{
	...
	public void run()
	{
    	...
    	try{
    		//获取被启用的所有被监视指标
    		monitorItemList = indicatorsdao.getByIntervalAndType("1", "m",1,"host");
    	}catch(Exception e){
    		e.printStackTrace();
    	}finally{
    		indicatorsdao.close();
...
//    		}
			...
			SysLogger.info("********M1Telnet Thread Count : "+Thread.activeCount());
		}
	}
