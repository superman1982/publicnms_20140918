 ...
 *
 */
public class M10Task extends MonitorTask {
...
//        		Hashtable fanHash = new Hashtable();
//       		    Hashtable flashHash = new Hashtable();
//       		    Hashtable temperatureHash = new Hashtable();
//       		    Hashtable voltageHash = new Hashtable();
//       		    Hashtable fdbHash = new Hashtable();
//        		ParserXmlUtil xmlutil = new ParserXmlUtil();
//        		try{
//        			String path=ResourceCenter.getInstance().getSysPath()+"linuxserver/";
//        		memHash = xmlutil.parserNetWorkXml(path+ "net_mem.xml","memory");
//    			powerHash = xmlutil.parserNetWorkXml(path+ "net_envir.xml","power");
//    			fanHash = xmlutil.parserNetWorkXml(path+ "net_envir.xml","fan");
//    			flashHash = xmlutil.parserNetWorkXml(path+ "net_envir.xml","flash");
//    			temperatureHash = xmlutil.parserNetWorkXml(path+ "net_envir.xml","temperature");
//    			voltageHash = xmlutil.parserNetWorkXml(path+ "net_envir.xml","voltage");
//    			fdbHash=xmlutil.parserFdbXml(path+"net_fdb.xml");
//        		dataToMem(memHash, alldata, "memory", "memory");
//        		dataToMem(powerHash, alldata, "power", "power");
//        		dataToMem(fanHash, alldata, "fan", "fan");
//        		dataToMem(flashHash, alldata, "flash", "flash");
//        		dataToMem(temperatureHash, alldata, "temperature", "temperature");
//        		dataToMem(voltageHash, alldata, "voltage", "voltage");
//        		dataToMem(fdbHash, alldata, "fdb", "fdb");
//        		}catch(Exception e){
//        			e.printStackTrace();
//        		}
