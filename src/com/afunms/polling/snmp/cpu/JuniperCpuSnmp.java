...
//					valueArray[0][1]="1";
				...
				SysLogger.error("JuniperCpuSnmp error",e);
			}
			// -------------------------------------------------------------------------------------------cpu
			// end
		} catch (Exception e) {
			SysLogger.error("JuniperCpuSnmp collect_Data(NodeGatherIndicators nodeGatherIndicators) error",e);
		}
