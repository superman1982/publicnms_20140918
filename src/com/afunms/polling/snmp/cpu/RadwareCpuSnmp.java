 ...
 */
public class RadwareCpuSnmp extends SnmpMonitor {
	java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	/**
	 *  
	 */
	public RadwareCpuSnmp() {
	}
		...
		try {
		  ...
		  try{
			...
			if(valueArray == null || valueArray.length == 0){
				//valueArray = SnmpUtils.getCpuTableData(node.getIpAddress(), node.getCommunity(), oids2, node.getSnmpversion(), 3, 1000*30);
