...
import com.afunms.polling.snmp.cdp.CDPSnmp;
...
public class CiscoCpuSnmp extends SnmpMonitor {
	...
	public Hashtable collect_Data(NodeGatherIndicators nodeGatherIndicators) {	
		...
		CDPSnmp cdpSnmp = new CDPSnmp();
		//NodeGatherIndicators alarmIndicatorsNode = new NodeGatherIndicators();
		cdpSnmp.collect_Data(nodeGatherIndicators);
...
//		告警
		try {
			...
			e.printStackTrace();
			SysLogger.error("CISCO cpu 告警出错" , e);
		}
//	    try{
