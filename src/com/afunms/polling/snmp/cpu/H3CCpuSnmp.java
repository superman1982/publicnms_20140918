...
import com.afunms.polling.snmp.ndp.NDPSnmp;
...
//		NDPSnmp ndpSnmp = new NDPSnmp();
//		//NodeGatherIndicators alarmIndicatorsNode = new NodeGatherIndicators();
//		ndpSnmp.collect_Data(nodeGatherIndicators);
...
//   		     	};  
//		String[][] ndp_valueArray = null;
//		try{
//			ndp_valueArray = snmp.getTableData(node.getIpAddress(),node.getCommunity(),ndp_oids);
//		}catch(Exception e){
//			e.printStackTrace();
//		}
//		if(ndp_valueArray != null){
//		   	  for(int i=0;i<ndp_valueArray.length;i++)
//		   	  {
//		   		SysLogger.info(node.getIpAddress()+"  &&& DeviceId:"+ndp_valueArray[i][0]+"   PortName:"+ndp_valueArray[i][1]);
//
//		   	  }
//		}
			...
			Calendar date=Calendar.getInstance();
			  ...
			  try {
				  //-------------------------------------------------------------------------------------------cpu start
		   		 ...
		   		 if(node.getSysOid().trim().equals("1.3.6.1.4.1.2011.2.23.147")){//S5700
		   			oids = 
		   				new String[] {
		   					"1.3.6.1.4.1.2011.5.25.31.1.1.1.1.6"};
		   			oids2 = 
		   		...
		   		//1.3.6.1.4.1.2011.2.49 NE20 1.3.6.1.4.1.2011.2.23.147 s5700 wxy add
		   		    if(node.getSysOid().equals("1.3.6.1.4.1.2011.2.49")||node.getSysOid().trim().equals("1.3.6.1.4.1.2011.2.62.2.5") || node.getSysOid().trim().equals("1.3.6.1.4.1.2011.2.88.2")
		   		    	||node.getSysOid().trim().equals("1.3.6.1.4.1.2011.2.62.2.3") || node.getSysOid().trim().equals("1.3.6.1.4.1.2011.2.62.2.9")||node.getSysOid().trim().equals("1.3.6.1.4.1.2011.2.23.147"))
		   		    {
