 ...
 */
public class MotorolaVoltageSnmp extends SnmpMonitor {
	java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	/**
	 * 
	 */
	public MotorolaVoltageSnmp() {
	}
...
//	    ShareData.getSharedata().put(node.getIpAddress(), ipAllData);
	    ...
	    try{
			...
			List list = alarmIndicatorsUtil.getAlarmInicatorsThresholdForNode(String.valueOf(node.getId()), AlarmConstant.TYPE_NET, "motorola","voltage");
