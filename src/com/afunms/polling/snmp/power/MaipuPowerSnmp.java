 ...
 */
public class MaipuPowerSnmp extends SnmpMonitor {
	java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	/**
	 * 
	 */
	public MaipuPowerSnmp() {
	}
...
//    			    }
			  ...
			  try {
				  //-------------------------------------------------------------------------------------------电源 start
		   		  ...
		   		  if(node.getSysOid().startsWith("1.3.6.1.4.1.5651.")){
		   			...
		   			String[] oids =                
						  new String[] {               
							"1.3.6.1.4.1.5651.3.600.7.1.1.3",//描述
							"1.3.6.1.4.1.5651.3.600.7.1.1.9"//状态
		   			};
	    ...
	    try{
			...
			List list = alarmIndicatorsUtil.getAlarmInicatorsThresholdForNode(String.valueOf(node.getId()), AlarmConstant.TYPE_NET, "maipu","power");
