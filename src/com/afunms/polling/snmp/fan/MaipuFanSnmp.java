 ...
 */
public class MaipuFanSnmp extends SnmpMonitor {
...
//					-------------------------------------------------------------------------------------------风扇 start
		   		  ...
		   		  if(node.getSysOid().startsWith("1.3.6.1.4.1.5651.")){
		   			...
		   			String[] oids =                
						  new String[] {               
							"1.3.6.1.4.1.5651.3.600.8.2.1.2",//描述
							"1.3.6.1.4.1.5651.3.600.8.2.1.3"//状态
		   			};
...
//	    returnHash.put("fan", fanVector);
	    ...
	    try{
			...
			List list = alarmIndicatorsUtil.getAlarmInicatorsThresholdForNode(String.valueOf(node.getId()), AlarmConstant.TYPE_NET, "maipu","fan");
