 ...
 */
public class MaipuTemperatureSnmp extends SnmpMonitor {
	java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	/**
	 *     
	 */
	public MaipuTemperatureSnmp() {
	}
			  ...
			  try {
				  ...
				  String temp = "0";
		   		  if(node.getSysOid().startsWith("1.3.6.1.4.1.5651.")){
		   			...
		   			String[] oids =                
						  new String[] {               
//							"1.3.6.1.4.1.5651.3.600.7.1.1.3",//温度描述
							"1.3.6.1.4.1.5651.3.600.9.2.1.2"//温度
		   			};
...
//	    ShareData.getSharedata().put(node.getIpAddress(), ipAllData);
	  ...
	  //对温度进行告警检测
	    ...
	    try{
			...
			List list = alarmIndicatorsUtil.getAlarmInicatorsThresholdForNode(String.valueOf(node.getId()), AlarmConstant.TYPE_NET, "maipu","temperature");
