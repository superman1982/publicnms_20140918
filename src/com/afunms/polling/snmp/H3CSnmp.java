 ...
 */
public class H3CSnmp extends SnmpMonitor implements MonitorInterface {
				...
				if(valueArray != null){
						...
						if(value >0){
							flag = flag +1;
							  ...
							  SysLogger.info(host.getIpAddress()+" 温度： "+value);
						...
						if(value >0){
							flag = flag +1;
					   		...
					   		voltageList.add(alist);				   		
					   		  ...
					   		  interfacedata.setThevalue(value+"");
							  SysLogger.info(host.getIpAddress()+" 电压： "+value);
