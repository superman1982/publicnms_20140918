...
public class diff_match_patch {
  ...
  * 修改 蓝色
   */
  public String[] diff_Html(LinkedList<Diff> diffs) {
	  String add_color = "green";
	  String del_color = "blue";
	  String modify_color = "red";
	  String equal_color = "black";
	    	...
	    	for (int i=0;i<diffs.size();i++) {
	    	  Diff aDiff = diffs.get(i);	
	  	      ...
	  	      case INSERT:
	  	    	...
	  	    	if(isDel) {
	  	    		html1.append(delStr.toString().replace("color=\""+del_color+"\"", 

"color=\""+modify_color+"\""));
	  	    		delStr = new StringBuilder();
	  	    		isDel = false;
	  	    		html2.append("<font color=\""+modify_color+"\" >").append(text)
	  	            .append("</font>");	
	  	    	}else {
	  	    		html2.append("<font color=\""+add_color+"\" >").append(text)
	  	            .append("</font>");	
	  	    	}
	  	        break;
	  	      case DELETE:
	  	    	...
	  	    	isDel  = true;
	  	    	delStr.append("<font   color=\""+del_color+"\">").append(text)
  	            .append("</font>");
	  	        break;
	  	      case EQUAL:
	  	    	if(isDel) {
	  	        ...
	  	        html1.append("<font  style=\"font-weight:bold;\" color=\""+equal_color

+"\">").append(text).append("</font>");
	  	        html2.append("<font  style=\"font-weight:bold;\" color=\""+equal_color
...
+"\">").append(text).append("</font>");
	    ...
	    htmls[0] = html1.toString();
	    htmls[1] = html2.toString();
	    return htmls;
	  }
