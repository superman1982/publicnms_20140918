package com.afunms.detail.service.envInfo;
...
import com.afunms.temp.dao.ENVTempDao;
...
public class ENVInfoService {
	 ...
	 * @param nodeid
	 */
	public ENVInfoService(String nodeid, String type, String subtype) {
		this.nodeid = nodeid;
		this.type = type;
	 ...
	 * @return
	 */
	public List<NodeTemp> getCurrPerENVListInfo(){
		List<NodeTemp> nodeTempList = null;
		ENVTempDao envTempDao = new ENVTempDao();
		try {
			nodeTempList = envTempDao.getCurrENVList(nodeid, type, subtype);
