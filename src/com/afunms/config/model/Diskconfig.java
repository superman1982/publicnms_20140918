...
public class Diskconfig extends BaseVo implements Serializable {
	private Integer id;
	...
	/** full constructor */
	public Diskconfig(Integer id,String ipaddress,Integer portindex, String name, String linkuse, Integer sms, String bak,Integer reportflag) {		
		this.id = id;
	 ...
	 * @param string
	 */
	public void setDiskindex(Integer string) {
		diskindex = string;
	}
