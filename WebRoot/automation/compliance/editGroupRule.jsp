...
<script language="JavaScript" type="text/javascript">
   ...
   function updateGroupRule(){
        ...
        $.ajax({
			type:"POST",
			dataType:"json",
			url:"<%=rootPath%>/netCfgFileAjaxManager.ajax?action=updateGroupRule",
			data:"id="+id+"&checkbox="+str+"&name="+encodeURIComponent(name)+"&description="+encodeURIComponent(description)+"&random="+Math.random(),
													...
													<td>
														<table id="add-content-header" class="add-content-header" >
										                	<tr>
											                	...
											                	<td class="add-content-title">&nbsp; 自动化>> 配置文件管理>> 策略管理>> 规则组>> 修改规则组</td>
				        												...
				        												<table border="0" id="table1" cellpadding="0" cellspacing="1" width="100%">
																		   ...
																		   <tr>
																			...
																			<tr>
																				...
																				<br><input type="button" value="保 存" style="width:50" id="process2" onclick="updateGroupRule()">&nbsp;&nbsp;
