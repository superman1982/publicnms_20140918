	...
	<head>
		...
		<script language="JavaScript">
			...
			*/
			...
			function add(){
				mainForm.action = "<%=rootPath%>/vpntelnet.do?action=add";
				mainForm.submit();
			}
			
			function edit(){
				mainForm.action = "<%=rootPath%>/vpntelnet.do?action=edit&id=" + node;
				mainForm.submit();
			}
			...
			function toDetermine(){
				...
				for(var i = 0 ; i < radioes.length; i++){
					...
					if(radio.checked){
						...
						alarmWayIdEvent.value = document.getElementById("radio").value;
		...
		<script type="text/javascript">
			var curpage= <%=jp.getCurrentPage()%>;
  			...
  			var delAction = "<%=rootPath%>/vpntelnet.do?action=delete";
  			var listAction = "<%=rootPath%>/vpntelnet.do?action=chooselist";
		</script>
	</head>
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 告警 >> 告警配置 >> 告警方式配置 >> 告警方式 </td>
		        								...
		        								<table id="content-body" class="content-body">
													...
													<tr>
														<td>
															<table>
																<tr>
													    			<td class="body-data-title">序号</td>
							        							...
							        							<%
							        								...
							        								if(list != null && list.size() > 0) {
							        									for(int i = 0; i < list.size(); i++){
							        										...
							        										<tr>
																    			<td class="body-data-list"><INPUT type="radio" id="radio" name="radio" value="<%=alarmWay.getId()%>"><%=jp.getStartRow() + i%></td>
