...
<script language="JavaScript" type="text/javascript">
  function toAdd()
  {
     var chk1 = checkinput("title","string","菜单",14,false);
     var chk2 = checkinput("url","string","URL",100,false);

     if(chk1&&chk2)
     {
        mainForm.action = "<%=rootPath%>/menu.do?action=add_sub";
        mainForm.submit();
     }
  }
</script>
			...
			<tr>
				...
				<td height=300 bgcolor="#FFFFFF" valign="top"  align="center">
				  <table border="0" id="table1" cellpadding="0" cellspacing="1"
					...
					<TBODY>
						<tr>
							<TD align="left" colspan="4" height="24">二级菜单--添加</TD>
						</tr>
						<tr>
							<td nowrap colspan="4" height="3" bgcolor="#8EADD5"></td>
						</tr>
						<tr style="background-color: #ECECEC;">
						    <TD nowrap align="right" height="24" width="10%">二级菜单&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;<input type="text" name="title" size="20" class="formStyle"><font color="red">&nbsp;*</font></TD>
						</tr>
						<tr>
						    <TD nowrap align="right" height="24" width="10%">URL&nbsp;</TD>				
							<TD nowrap width="40%">&nbsp;<input type="text" name="url" size="30" class="formStyle"><font color="red">&nbsp;*</font></TD>
						</tr>
						<tr>
