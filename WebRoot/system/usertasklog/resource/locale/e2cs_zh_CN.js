...
e2cs.cal_locale={
	...
	tooltipListView:    '查看列表视图...',    // 20091208 add
	...
	// Month view locale
	win_month_zoomlabel:'日志', 				//0.0.7  tasks changed to events
	headerTooltipsMonth: { 
		prev: '上月.', 
		next: '下月.' 
	}, 
	...
	labelforTasksinMonth: '日志:',				//0.0.7  tasks changed to events
	//-----------------------------------------------------------------
	...
	contextMenuLabelsDay: { 
		taskAdd: "新日志", 							//0.0.7  tasks changed to events
		taskDelete: "删除日志", 					//0.0.7  tasks changed to events
		taskEdit: "编辑日志:",						//0.0.7  tasks changed to events
		NextDay: "下一日", 
		PreviousDay: "上一日",
		chgwview: "切换至周视图...", 
		chgmview: "切换至月视图...",
	...
	labelforTasksinWeek: '更多周日志:',   		//0.0.7  tasks changed to events
	win_week_zoomlabel:'更多日志...',				//0.0.7  tasks changed to events
	weekheaderlabel:'周 #',
