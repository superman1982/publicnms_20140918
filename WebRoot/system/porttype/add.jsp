								...
								<table id="container-main-add" class="container-main-add">
									<tr>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">系统管理 >>资源管理>> 添加端口类型</td>
								     ...
								     <tr style="background-color: #ECECEC;">						
									    ...
									    <TD nowrap width="40%">&nbsp;
										<input type="text" id="typeid" name="typeid" maxlength="50" size="20" class="formStyle">
									</TD>
									<TD nowrap align="center" height="24" width="10%">名称&nbsp;</TD>				
									<TD nowrap width="40%">&nbsp;
										<input type="text" id="chname" name="chname" maxlength="50" size="20" class="formStyle">
									</TD>
								</tr>
								<tr style="background-color: #ECECEC;">					
