...
<%
  ...
  String password_0 = request.getParameter("password_0");//初始密码
  if(pwd.equals(""))
     vo.setPassword(password_0);
  else   
  {
      MD5 md = new MD5();
		...
		<table id="body-container" class="body-container">
			<tr>
				...
				<td class="td-container-main">
					...
					<tr>
						  <td align="center" height="100"><img src="<%=rootPath%>/resource/image/smile.gif" height="50" width="50" border=0>
						  <font color="#008000"><b>更新成功!</b></font>&nbsp;&nbsp;</td>
		            </tr>
