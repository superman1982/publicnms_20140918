...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/ftptrans.do?action=add";
            mainForm.submit();
     }
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">系统管理 >> 系统设置 >> FTP传输配置添加</td>
				        									...
				        									<tr>
																...
																<tr style="background-color: #ECECEC;">
																	...
																	<TD nowrap align="right" height="24" width="10%">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码&nbsp;</TD>	
																		<TD nowrap width="40%">&nbsp;<input type="password" name="password" size="16" value="" class="formStyle"><font color="red">&nbsp;*</font></TD>
																</tr>
																	<tr style="background-color: #ECECEC;">
