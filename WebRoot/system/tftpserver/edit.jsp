...
<%
   TFtpServer vo = (TFtpServer)request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1)
     {
        	...
        	mainForm.action = "<%=rootPath%>/tftpserver.do?action=update";
           mainForm.submit();
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">系统管理 >> 系统设置 >> TFtp服务地址编辑</td>
