...
function toAdd()
  {
     ...
     {
        mainForm.action = "<%=rootPath%>/alertemail.do?action=add";
        mainForm.submit();
     }
  }
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">系统管理 >> 系统设置 >> 消息服务器设置添加</td>
						...
						<tr style="background-color: #ECECEC;">
							...
							<TD nowrap width="40%">&nbsp;<input type="text" name="username" size="16" value="" class="formStyle"><font color="red">&nbsp;*</font></TD>
							<TD nowrap align="right" height="24">SMTP&nbsp;</TD>				
							<TD nowrap>
								&nbsp;<input type="text" name="smtp" size="16" class="formStyle"><font color="red">&nbsp;*</font>
							</TD>	
						</tr>
						<tr>	
							<TD nowrap align="right" height="24">密码&nbsp;</TD>				
							<TD nowrap>
								&nbsp;<input name="password" type="password" size="16"  class="formStyle"><font color="red">&nbsp;*</font>
							</TD>						
							<TD nowrap align="right" height="24">确认密码&nbsp;</TD>				
							<TD nowrap>&nbsp;<input name="password0" type="password" size="16" class="formStyle"><font color="red">&nbsp;*</font>														
							</TD>	
						</tr>
						<tr style="background-color: #ECECEC;">
							...
							<TD nowrap>&nbsp;<input name="email_address" type="text" size="30" class="formStyle"><font color="red">&nbsp;*</font>														
							</TD>
						</tr>																	
						<tr>
