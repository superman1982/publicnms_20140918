 ...
 Ext.get("process").on("click",function(){
    ...
    var chk = checkinput("name","string","名称",30,false);
     ...
     {      
        	...
        	mainForm.action = "<%=rootPath%>/snmp.do?action=add";
        	mainForm.submit();
     }
       // mainForm.submit();
 });	
							...
							<td class="td-container-main-add">
								<table id="container-main-add" class="container-main-add">
									<tr>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">系统管理 >> 资源管理 >> SNMP设置添加</td>
                  					...
                  					<TD nowrap width="20%">&nbsp;&nbsp;<input type="text" name="name" maxlength="50" size="20" class="formStyle" value=""></TD>
                				</tr> 
                  				<tr>
                				...
                				<tr bgcolor="#F1F1F1">
                  					...
                  					<TD nowrap width="20%">&nbsp;
                  					<input type="text" name="readcommunity" maxlength="50" size="20" class="formStyle" value="">
                  					</TD>
                				</tr> 
                				<tr>
                  					<TD nowrap align="right" height="24" width="10%">写团体&nbsp;</TD>
                  					<TD nowrap width="20%">&nbsp;
                  					<input type="text" name="writecommunity" maxlength="50" size="20" class="formStyle" value="">
                  					</TD>
                				</tr>
                				<tr bgcolor="#F1F1F1">
                  					<TD nowrap align="right" height="24" width="10%">超时时间(秒)&nbsp;</TD>
                  					<TD nowrap width="20%">&nbsp;
                  					<input type="text" name="timeout" maxlength="50" size="20" class="formStyle" value="">
                  					</TD>
                				</tr>
                				<tr>
                  					<TD nowrap align="right" height="24" width="10%">重试次数&nbsp;</TD>
                  					<TD nowrap width="20%">&nbsp;
                  					<input type="text" name="trytime" maxlength="50" size="20" class="formStyle" value="">
                  					</TD>
                				</tr>                       										                 										                      								
