...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     var chk1 = checkinput("ipaddress","string","IP地址",50,false);
     var chk2 = checkinput("port","string","端口号",50,false);

     if(chk1&&chk2)
     {      
            Ext.MessageBox.wait('数据加载中，请稍后.. ');
        	mainForm.action = "<%=rootPath%>/alertinfo.do?action=add";
            mainForm.submit();
     }
       // mainForm.submit();
 });	
																	...
																	<td>
																		...
																		<table border="0" id="table1" cellpadding="0"
																			...
																			<tr style="background-color: #ECECEC;">
																				...
																				<TD nowrap width="20%">
																					&nbsp;
																					<input type="text" name="port" size="16" value="5000"
																						class="formStyle">
																					<font color="red">&nbsp;*</font>
																				</TD>
																				<TD nowrap height="24">
