...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
     ...
     if(chk1&&chk2&&chk3)
     {
        mainForm.action = "<%=rootPath%>/dept.do?action=add";
        mainForm.submit();
     }
       // mainForm.submit();
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">系统管理 >> 部门管理 >> 添加</td>
				        						...
				        						<tr>
				        							<td>
														...
														<tr style="background-color: #ECECEC;">
															...
															<TD nowrap width="40%">&nbsp;<input type="text" name="dept" size="16" class="formStyle"><font color="red">&nbsp;*</font></TD>
															<TD nowrap align="right" height="24">联系人&nbsp;</TD>				
															<TD nowrap>&nbsp;<input type="text" name="man" size="16" class="formStyle"></TD>	
														</tr>
														<tr>
														    <TD nowrap align="right" height="24" width="10%">电话&nbsp;</TD>				
															<TD nowrap width="40%">&nbsp;<input type="text" name="tel" size="16" class="formStyle"></TD>
