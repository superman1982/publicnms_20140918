...
function initmenu()
{
	...
	<body id="body" class="body" onload="initmenu();">
		<form action="<%=rootPath%>/controller/processDeploy.action" method="post" enctype="multipart/form-data">
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 流程 >> 流程管理 >> 流程部署 </td>
		        						...
		        						<tr>
		        							<td>
		        								<table id="content-body" class="content-body">
													<tr>
														<td><font class="font14">上传文件(xml, bpm, bar, zip文件)：</font>
															<input type="file" name="file" />
															<input name="submit" type="submit" class="botton" value="部署"/>
														</td>
													</tr>
		        								</table>
		        							</td>
