...
function initmenu()
{
	...
	<body id="body" class="body" onload="initmenu();">
		<form action="<%=rootPath%>/controller/formDeploy.action" method="post" enctype="multipart/form-data">
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 流程 >> 流程管理 >> 上传表单 </td>
		        						...
		        						<tr>
		        							<td>
		        								<table id="content-body" class="content-body">
													<tr><td><font class="font14">上传form文件：</font>
													<input type="file" name="file" />
													</td>
													</tr>
													<tr><td><font class="font14">form对应图片：</font>
													<input type="file" name="filepic" />
													<input name="submit" type="submit" class="botton" value="上传"/>
													</td>
													</tr>
		        								</table>
		        							</td>
