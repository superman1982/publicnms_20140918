...
HostDetail.prototype = {
	...
	show: function (){
		...
		if(freshSystemInfo){
			freshSystemInfo.onclick = function (){
				AixRemoteService.getHostNodeInfo(ObjectSelf.nodeid, ObjectSelf.type, ObjectSelf.subtype, {
		...
		AixRemoteService.getHostNodeInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
				ObjectSelf.hostNode =  data;
				ObjectSelf.getSystemInfo();
			}
	...
	getSystemInfo: function (){
		AixRemoteService.getSystemInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
	...
	createSystemInfo: function (){ 
		...
		AixRemoteService.getCurrDayPingAvgInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
		...
		AixRemoteService.getCurrCpuAvgInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
		...
		AixRemoteService.getStautsInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
				var statusImg = "";
				if(data){
					statusImg = data;
		...
		AixRemoteService.getCategoryInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
				var category = "";
				if(data){
					category = data;
		...
		AixRemoteService.getSupperInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
				var supperInfo = "";
				if(data){
					supperInfo = data;
	...
	// 获取详细信息页面上标签页的信息
	getTabInfo: function (){
		AixRemoteService.getTabInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
	...
	getInterfaceInfo: function(){
		AixRemoteService.getInterfaceInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
	...
	createPerformaceInfo: function(){
		...
		AixRemoteService.getDiskInfoUtilizationImg(this.nodeid, this.type, this.subtype, {
			callback:function(data){
		...
		AixRemoteService.getDiskInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
	...
	createSysInfo: function(){
		...
		// 获取cpu性能信息
		AixRemoteService.getCpuPerfInfo(this.nodeid, this.type, this.subtype,{
			callback: function(data){
		...
		// 获取磁盘性能信息
		AixRemoteService.getDiskPerfInfo(this.nodeid, this.type, this.subtype,{
			callback: function(data){
		...
		// 获取页面性能信息
		AixRemoteService.getPagePerfInfo(this.nodeid, this.type, this.subtype,{
			callback: function(data){
		...
		// 获取页面交换信息
		AixRemoteService.getPageSpaceInfo(this.nodeid, this.type, this.subtype,{
			callback: function(data){
	...
	createConfigInfo: function(){
		...
		// 获取内存配置信息
		AixRemoteService.getMemoryConfigInfo(this.nodeid, this.type, this.subtype,{
			callback: function(data){
		...
		// 获取网卡配置信息
		AixRemoteService.getNetmediaConfigInfo(this.nodeid, this.type, this.subtype,{
			callback: function(data){
		...
		// 获取用户配置信息
		AixRemoteService.getUserConfigInfo(this.nodeid, this.type, this.subtype,{
			callback: function(data){
	...
	getProcessInfo: function(){
		AixRemoteService.getProcessInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
	...
	showProcessInfoDetail: function(name){
		AixRemoteService.getProcessDetailInfo(this.nodeid, this.type, this.subtype, name, {
			callback:function(data){
	...
	getSoftwareInfo: function (){
		AixRemoteService.getSoftwareInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
	...
	getServiceInfo: function (){
		AixRemoteService.getServiceInfo(this.nodeid, this.type, this.subtype, {
			callback:function(data){
	...
	getSyslogInfo: function (){
		...
		AixRemoteService.getSyslogInfo(this.nodeid, this.type, this.subtype, 
	...
	getDeviceInfo: function (){
		AixRemoteService.getDeviceInfo(this.nodeid, this.type, this.subtype, {
				callback:function(data){
	...
	getStorageInfo: function (){
		AixRemoteService.getStorageInfo(this.nodeid, this.type, this.subtype, {
				callback:function(data){
	...
	getAlarmInfo: function(){
		...
		AixRemoteService.getAlarmInfo(this.nodeid, this.type, this.subtype, 
	...
	showAlarmDetailInfo: function(eventlocation, subentity){
		...
		AixRemoteService.getAlarmDetailInfo(this.nodeid, this.type, this.subtype, 
