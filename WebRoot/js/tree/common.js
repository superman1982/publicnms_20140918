...
function XMLLoader(funcObject, dhtmlObject, async, rSeed)
{
	this.xmlDoc = "";
...
XMLLoader.prototype.waitLoadFunction = function (dhtmlObject)
{
	this.check = function()
	{
...
XMLLoader.prototype.getXMLTopNode = function (tagName)
{
...
XMLLoader.prototype.loadXMLString = function (xmlString)
{
	try
	{
...
XMLLoader.prototype.loadXML = function (filePath, postMode, postVars)
{
	if (this.rSeed)
...
XMLLoader.prototype.destructor = function()
{
...
XMLLoader.prototype.doXPath = function(xpathExp,docObj)
{
...
XMLLoader.prototype.doXPathOpera = function(xpathExp,docObj)
{
...
XMLLoader.prototype._filterXPath = function(a,b)
{
	var c=new Array();
...
XMLLoader.prototype._getAllNamedChilds = function(a,b)
{
	var c=new Array();
	for(var i=0;i<a.length;i++)
