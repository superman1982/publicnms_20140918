...
HomeHelper helper=new HomeHelper();
 List monitorDBDTOList = (List)helper.getFireWallview();
	String cpuUsed = "0";
	String cpuUnUsed = "";
					        									    ...
					        									    if(monitorDBDTOList!=null&& monitorDBDTOList.size()>0){
					        									        ...
					        									        for(int i = 0 ; i < monitorDBDTOList.size() ; i++){ 
					        									            ...
					        									            <tr <%=onmouseoverstyle%>>
					        													...
					        													<td align="left" class="body-data-list"><a href="#" onclick="openPreWin('<%=monitorNodeDTO.getId()%>')">
					        														<%=monitorNodeDTO.getAlias()%>
					        														</a>
					        													</td>
					        													<td align="center" class="body-data-list"><%=monitorNodeDTO.getIpAddress() %></td>
