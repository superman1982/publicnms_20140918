...
HomeHelper helper=new HomeHelper();
 List monitorDBDTOList = (List)helper.getHostview();
...
<html>
  <head>
   ...
   <script type="text/javascript">
			...
			function doInit()
	  {
		setInterval(autoRefresh,1000*3000*1);
	  }
	...
	window.parent.location.href="<%=rootPath%>/detail/dispatcher.jsp?id=net"+id+"&fromtopo=true";
	//window.parent.location.href="/afunms/detail/dispatcher.jsp?id=net"+id+"&fromtopo=true";
	}
   </script>
  </head>
  ...
  <body onload="doInit()" >
				...
				<table>
		        												<tr>
		        													<td align="center" valign=top class="body-data-title" width="10%">状态</td>
		        													<td align="center"  valign=top class="body-data-title" width="30%">名称</td>
