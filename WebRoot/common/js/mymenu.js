...
(function (b) {
	b.fn.superfish = function (k) {
		var g = b.fn.superfish, j = g.c, f = b(["<span class=\"", j.arrowClass, "\"> &#187;</span>"].join("")), i = function () {
			var c = b(this), l = d(c);
			clearTimeout(l.sfTimer);
			c.showSuperfishUl().siblings().hideSuperfishUl();
		}, e = function () {
			var c = b(this), m = d(c), l = g.op;
	...
	a.defaults = {hoverClass:"sfHover", pathClass:"overideThisToUse", pathLevels:1, delay:800, animation:{opacity:"show"}, speed:"normal", autoArrows:true, dropShadows:true, disableHI:false, onInit:function () {
	...
	b.fn.extend({hideSuperfishUl:function () {
		...
		var e = a.op, d = a.c.shadowClass + "-off", c = this.addClass(e.hoverClass).find(">ul:hidden").css("visibility", "visible");
		a.IE7fix.call(c);
...
(function (a) {
	a.fn.supersubs = function (b) {
		...
		return this.each(function () {
			...
			var f = a("<li id=\"menu-fontsize\">&#8212;</li>").css({padding:0, position:"absolute", top:"-999em", width:"auto"}).appendTo(d).width();
			...
			$ULs.each(function (l) {
				...
				var h = k.add(j).add(g).css({"float":"none", width:"auto"}).end().end()[0].clientWidth / f;
				h += e.extraWidth;
				if (h > e.maxWidth) {
					h = e.maxWidth;
				} else {
				...
				h += "em";
				k.css("width", h);
				j.css({"float":m, width:"100%", "white-space":"normal"}).each(function () {
					var n = a(">ul", this);
...
$(document).ready(function () {
	$("ul.sf-menu").supersubs({minWidth:12, maxWidth:30, extraWidth:1}).superfish();
});
