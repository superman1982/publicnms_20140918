		...
		<script language="JavaScript">
			...
			*/
			...
			function cancelmanage()
			{
			  ...
			  function toAdd()
  			{
      				mainForm.action = "<%=rootPath%>/alarmIndicatorsNode.do?action=showtoaddlist&category=physical";
      				mainForm.submit();
  			}
  			  function toMultiAdd()
  			{
															...
															<table>
							        							...
							        							<%
							        								...
							        								if(list != null && list.size() > 0) {
							        								 session.setAttribute("flag","physical");
							        								 int h=0;
							        									for(int i = 0; i < list.size(); i++){
							        										AlarmIndicatorsNode alarmIndicatorsNode = (AlarmIndicatorsNode)list.get(i);
							        										if(!alarmIndicatorsNode.getCategory().equalsIgnoreCase("physical"))continue;
							        										h=h+1;
							        										String isMonitor = "否";
							        										String bcolor="gray";
							        										...
							        										<tr <%=onmouseoverstyle%>>
																    			...
																    			<td class="body-data-list"><%if(vmData == null){out.println("请稍等...");}else{out.println(vmData.get(alarmIndicatorsNode.getSubentity()));}%></td>
