		...
		<script language="JavaScript">
			...
			*/
			...
			function cancelmanage()
			{
			  ...
			  function toAdd()
  			{
      				mainForm.action = "<%=rootPath%>/alarmIndicatorsNode.do?action=showtoaddlist&category=yun";
      				mainForm.submit();
  			}
  			  function toMultiAdd()
  			{
															...
															<table>
							        							...
							        							<%
							        								...
							        								if(list != null && list.size() > 0) {
							        								 session.setAttribute("flag","yun");
							        								 int h=0;
							        									for(int i = 0; i < list.size(); i++){
							        										AlarmIndicatorsNode alarmIndicatorsNode = (AlarmIndicatorsNode)list.get(i);
							        										if(!alarmIndicatorsNode.getCategory().equalsIgnoreCase("yun"))continue;
							        										h=h+1;
							        										String isMonitor = "否";
							        										String bcolor="gray";
