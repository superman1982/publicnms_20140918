...
<html>
  ...
  function doAdd()
  {
      mainForm.action = "<%=rootPath%>/alarmIndicatorsNode.do?action=addselectedshowkey";
      mainForm.submit();
  }
	...
	<body id="body" class="body" onload="initmenu();">
		...
		<form id="mainForm" method="post" name="mainForm">
			...
			<input type="hidden" name="topoid" id="topoid" value="<%=topoid%>">
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 资源 >> 性能监视 >> 设置快捷显示指标 </td>
		        								...
		        								<table id="content-body" class="content-body">
													<tr>
														<td>
															<table>
																<tr>
																<td class="body-data-title" width=10%>序号</td>
													    			<td class="body-data-title" width=45%>名称</td>
													    			<td class="body-data-title" width=45%>描述</td>
							        							</tr>
							        							<%
							        								...
							        								if(list != null && list.size() > 0) {
							        									for(int i = 0; i < list.size(); i++){
							        										...
							        										//if(!subtype.equalsIgnoreCase("vmware")){
							        										 if(moidhash.containsKey(alarmIndicators.getId()+"")){
							        											dis = "checked";
							        										 }
							        										//}
