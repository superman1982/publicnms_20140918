		...
		<script language="JavaScript">
			...
			*/
			...
			function cancelmanage()
			{
			  ...
			  function toAdd()
  			{
      				mainForm.action = "<%=rootPath%>/alarmIndicatorsNode.do?action=showtoaddlist&category=resource";
      				mainForm.submit();
  			}
  			  function toMultiAdd()
  			{
							        								...
							        								if(list != null && list.size() > 0) {
							        								 ...
							        								 int h=0;
							        									for(int i = 0; i < list.size(); i++){
							        										...
							        										if(!alarmIndicatorsNode.getCategory().equalsIgnoreCase("resourcepool"))continue;
							        										h=h+1;
							        										String isMonitor = "否";
							        										String bcolor="gray";
