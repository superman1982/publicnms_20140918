			...
			*/
			...
			function toDetermine(){
				...
				for(var i = 0 ; i < radioes.length; i++){
					var radio = radioes[i];
					if(radio.checked){
						idvalues = idvalues+radio.value + ",";
						namevalue = namevalue+document.getElementById("alarmWayName-" + radio.value).value +","; 
					}
				}
				...
				alarmWayIdEvent.value = idvalues;
				alarmWayNameEvent.value = namevalue;
				window.close();
			}
							        							...
							        							<%
							        								...
							        								if(list != null && list.size() > 0) {
							        									for(int i = 0; i < list.size(); i++){
							        										...
							        										<tr>
																    			<td class="body-data-list"><INPUT type="checkbox" name="radio" value="<%=alarmWay.getId()%>"><%=jp.getStartRow() + i%></td>
