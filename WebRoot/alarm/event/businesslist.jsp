...
function accEvent(eventid){
  ...
  function query()
  {  
     mainForm.action = "<%=rootPath%>/event.do?action=businesslist&jp=1";
     mainForm.submit();
  }  
  function doQuery()
  {  
...
<table id="body-container" class="body-container">
			...
			<tr>
				<td background="<%=rootPath%>/common/images/right_t_02.jpg" width="100%"><table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="layout_title"><b>告警 >> 告警统计 >> 按业务分布</b></td>
  ...
  <tr  class="microsoftLook0" height=28>
        ...
        <td width="15%" align="center"><strong>业务名称</strong></td>
...
<%
  	...
  	for(int i=0;i<list.size();i++){
  		...
  		Business busi = (Business)rlist.get(0);
